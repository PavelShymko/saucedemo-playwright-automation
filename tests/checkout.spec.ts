    ...
    test('open empty checkout page', async ({ page }) => {
    ...
    test('fill checkout information and finish checkout', async ({ page }) => {
        const cartPage = new CartPage(page);
        const checkoutPage = new CheckoutPage(page);
        await cartPage.openCart()
        await checkoutPage.openCheckout()
    ...
    test('checkout information is required - all fields', async ({ page }) => {
        const cartPage = new CartPage(page);
        const checkoutPage = new CheckoutPage(page);
        await cartPage.openCart()
        await checkoutPage.openCheckout()
    ...
    test('checkout information is required - last name', async ({ page }) => {
        const cartPage = new CartPage(page);
        const checkoutPage = new CheckoutPage(page);
        await cartPage.openCart()
        await checkoutPage.openCheckout()
    ...
    test('checkout information is required - postal code', async ({ page }) => {
        const cartPage = new CartPage(page);
        const checkoutPage = new CheckoutPage(page);
        await cartPage.openCart()
        await checkoutPage.openCheckout()
    ...
    test('checkout information is required - first name', async ({ page }) => {
        const cartPage = new CartPage(page);
        const checkoutPage = new CheckoutPage(page);
        await cartPage.openCart()
        await checkoutPage.openCheckout()
    ...
    test('display correct product information on checkout page', async ({ page }) => {
        ...
        await cartPage.openCart()
        const checkoutProductName = await page.locator('.inventory_item_name').innerText()
        const checkoutProductPrice = await page.locator('.inventory_item_price').innerText()
        expect(checkoutProductName).toBe(productName)
        expect(checkoutProductPrice).toBe(productPrice)
    })
    test('display correct product information on checkout overview page', async ({ page }) => {
        const productsPage = new ProductsPage(page);
        const cartPage = new CartPage(page);
        const checkoutPage = new CheckoutPage(page);
        await productsPage.openFirstProduct()
        ...
        const overviewProductPrice = await page.locator('.inventory_item_price').innerText()
    ...
    test('add two products to cart and complete purchase successfully', async ({ page }) => {
        const productsPage = new ProductsPage(page);
        const cartPage = new CartPage(page);
        const checkoutPage = new CheckoutPage(page);
        await productsPage.openFirstProduct()
